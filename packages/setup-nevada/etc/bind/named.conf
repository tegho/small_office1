...
view "vpn_clients" {
  ...
  zone "nevada" {
    type            master;
    file            "/var/cache/bind/zones/nevada";
    check-names     ignore;
  ...
  zone "192.168.192.in-addr.arpa" {
    type            master;
    file            "/var/cache/bind/zones/nevada-192.v4.ptr";
    check-names     ignore;
    allow-transfer  { "allow_transfers"; };
    allow-update    { key vpn-update-key; };
  };
  ...
  zone "193.168.192.in-addr.arpa" {
    type            master;
    file            "/var/cache/bind/zones/nevada-193.v4.ptr";
    check-names     ignore;
    allow-transfer  { "allow_transfers"; };
    allow-update    { key vpn-update-key; };
  };
  ...
  zone "194.168.192.in-addr.arpa" {
    type            master;
    file            "/var/cache/bind/zones/nevada-194.v4.ptr";
    check-names     ignore;
    allow-transfer  { "allow_transfers"; };
    allow-update    { key vpn-update-key; };
  };
  ...
  zone "195.168.192.in-addr.arpa" {
    type            master;
    file            "/var/cache/bind/zones/nevada-195.v4.ptr";
    check-names     ignore;
    allow-transfer  { "allow_transfers"; };
    allow-update    { key vpn-update-key; };
  };
...
#    type            master;
#    file            "/var/cache/bind/zones/nevada.v6.ptr";
#    check-names     ignore;
#    allow-transfer  { "allow_transfers"; };
#    allow-update    { key vpn-update-key; };
#  };
